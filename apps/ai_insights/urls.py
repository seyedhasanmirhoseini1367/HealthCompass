...
urlpatterns = [
    ...
    path('icu/', views.icu_demo, name='icu_demo'),
    path('ajax/lab-records/', views.ajax_lab_records, name='ajax_lab_records'),
    path('ajax/record-labs/<str:pk>/', views.ajax_record_labs, name='ajax_record_labs'),
